...
# Compatibility shim: on some Python versions (or if pkgutil is shadowed),
# pkgutil may not provide get_loader. Flask expects it; add a small
# fallback using importlib.util.find_spec so the app can start.
